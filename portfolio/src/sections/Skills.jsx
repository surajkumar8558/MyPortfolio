...
function Skills(){
    ...
    return (
        <>
            <div id="Skills" className=" min-h-[90vh] bg-background flex justify-center items-center flex-col">
                ...
                " >
                    {
                        skills.map((skill, index) => (
                            <div key={index} className="bg-card shadow-2xl flex h-40 w-72 rounded-xl justify-center items-center">
